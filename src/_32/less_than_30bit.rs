...
pub fn fwd_butterfly_avx512(
    ...
    let z0 = simd.small_mod_epu32(two_p, z0);
...
pub fn inv_butterfly_avx512(
    ...
    let y0 = simd.small_mod_epu32(two_p, y0);
...
#[cfg(feature = "nightly")]
#[inline(always)]
pub fn inv_last_butterfly_avx512(
    simd: Avx512,
    z0: __m512i,
    z1: __m512i,
    w: __m512i,
    ...
    (simd.small_mod_epu32(p, y0), simd.small_mod_epu32(p, y1))
}
...
#[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
#[inline(always)]
pub fn inv_last_butterfly_avx2(
    simd: Avx2,
    z0: __m256i,
    z1: __m256i,
    w: __m256i,
...
#[inline(always)]
pub fn inv_last_butterfly_scalar(
    z0: u32,
    z1: u32,
    w: u32,
    w_shoup: u32,
