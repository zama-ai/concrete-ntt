...
pub fn fwd_butterfly_avx512(
    ...
    let z0 = avx._mm512_mask_blend_epi32(
        avx._mm512_cmpge_epu32_mask(z0, two_p),
        z0,
        avx._mm512_sub_epi32(z0, two_p),
    );
    ...
    (
        ...
        avx._mm512_add_epi32(avx._mm512_sub_epi32(z0, t), two_p),
    )
}
...
pub fn fwd_butterfly_avx2(
    ...
    let z0 = avx._mm256_blendv_epi8(
        avx._mm256_sub_epi32(z0, two_p),
        z0,
        simd._mm256_cmpgt_epu32(two_p, z0),
    );
    let shoup_q = simd._mm256_mul_u32_u32_epu32(z1, w_shoup).1;
    let t = avx._mm256_add_epi32(
        simd._mm256_mul_u32_u32_epu32(z1, w).0,
        simd._mm256_mul_u32_u32_epu32(shoup_q, neg_p).0,
    );
    (
        avx._mm256_add_epi32(z0, t),
        avx._mm256_add_epi32(avx._mm256_sub_epi32(z0, t), two_p),
    )
}
...
pub fn inv_butterfly_avx512(
    ...
    let y0 = avx._mm512_mask_blend_epi32(
        avx._mm512_cmpge_epu32_mask(y0, two_p),
        y0,
        avx._mm512_sub_epi32(y0, two_p),
    );
    let t = avx._mm512_add_epi32(avx._mm512_sub_epi32(z0, z1), two_p);
...
pub fn inv_butterfly_avx2(
    ...
    let y0 = avx._mm256_blendv_epi8(
        avx._mm256_sub_epi32(y0, two_p),
        y0,
        simd._mm256_cmpgt_epu32(two_p, y0),
    );
    let t = avx._mm256_add_epi32(avx._mm256_sub_epi32(z0, z1), two_p);

    let shoup_q = simd._mm256_mul_u32_u32_epu32(t, w_shoup).1;
    let y1 = avx._mm256_add_epi32(
        simd._mm256_mul_u32_u32_epu32(t, w).0,
        simd._mm256_mul_u32_u32_epu32(shoup_q, neg_p).0,
    );
